          ...
          <ul className="orders__list">
            <li className="orders__item">
              ...
              <span className="orders__items">товаров&nbsp;
                <b className="orders__items-qty">4</b></span><span className="orders__date">13.09.2022</span><b className="orders__sum">35 000<span className="orders__rouble">₽</span></b>
              <button
